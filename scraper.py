...
IT_KEYWORDS = [
    "developer", "ontwikkelaar", "engineer", "software", "devops", "data",
    "cloud", "ict", "it ", " it", "system", "systeem", "network", "netwerk",
    "security", "analist", "analyst", "architect", "sap", "erp", "crm",
    "frontend", "front-end", "backend", "back-end", "fullstack", "full-stack",
    "java", "python", ".net", "php", "scrum", "agile", "product owner",
    "tester", "qa ", "test engineer", "database", "bi ", "machine learning",
    "ai ", "infrastructure", "infrastructuur", "helpdesk", "support engineer",
    "applicatiebeheer", "functioneel", "digital",
]
...
def extract_job_links(html: str, base_url: str) -> list[dict]:
    ...
    for a in soup.find_all("a", href=True):
        ...
        if urlparse(href).netloc == "":
            continue
        if not looks_like_it_job(title):
            continue
        key = href.split("#")[0]
        if key in seen_here:
            continue
